...
export interface CwdSubdaoTimelockSingleSchema {
  responses: Config | ProposalListResponse | SingleChoiceProposal1;
  query: ProposalArgs;
  execute: TimelockProposalArgs | ExecuteProposalArgs | OverruleProposalArgs | UpdateConfigArgs;
  [k: string]: unknown;
}
...
export interface SingleChoiceProposal1 {
  /**
   * The ID of the proposal being returned.
   */
  id: number;
...
export interface TimelockProposalArgs {
  msgs: CosmosMsgFor_NeutronMsg[];
  proposal_id: number;
  [k: string]: unknown;
}
export interface ExecuteProposalArgs {
  proposal_id: number;
  [k: string]: unknown;
}
export interface OverruleProposalArgs {
  proposal_id: number;
  [k: string]: unknown;
}
...
export class Client {
  ...
  queryProposal = async(args: ProposalArgs): Promise<SingleChoiceProposal> => {
  ...
  timelockProposal = async(sender:string, args: TimelockProposalArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
    return this.client.execute(sender, this.contractAddress, { timelock_proposal: args }, fee || "auto", memo, funds);
  }
  executeProposal = async(sender:string, args: ExecuteProposalArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
    return this.client.execute(sender, this.contractAddress, { execute_proposal: args }, fee || "auto", memo, funds);
  }
  overruleProposal = async(sender:string, args: OverruleProposalArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
    return this.client.execute(sender, this.contractAddress, { overrule_proposal: args }, fee || "auto", memo, funds);
  }
