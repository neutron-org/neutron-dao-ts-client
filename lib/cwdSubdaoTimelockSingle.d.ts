...
export declare class Client {
    ...
    queryProposal: (args: ProposalArgs) => Promise<SingleChoiceProposal>;
    queryListProposals: () => Promise<ProposalListResponse>;
    timelockProposal: (sender: string, args: TimelockProposalArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    executeProposal: (sender: string, args: ExecuteProposalArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    overruleProposal: (sender: string, args: OverruleProposalArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
