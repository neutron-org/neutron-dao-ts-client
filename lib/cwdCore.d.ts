...
export type ArrayOfSubDao = SubDao1[];
/**
 * Information about if the contract is currently paused.
 */
...
export interface CwdCoreSchema {
    responses: ArrayOfProposalModule | Config | Nullable_String | DumpStateResponse | GetItemResponse | SubDao | InfoResponse | ArrayOfTupleOf_StringAnd_String | ArrayOfSubDao | PauseInfoResponse1 | ArrayOfProposalModule1 | TotalPowerAtHeightResponse | Addr1 | VotingPowerAtHeightResponse;
    query: GetItemArgs | GetSubDaoArgs | VotingPowerAtHeightArgs;
    execute: ExecuteProposalHookArgs | PauseArgs | RemoveItemArgs | SetItemArgs | UpdateConfigArgs | UpdateProposalModulesArgs | UpdateVotingModuleArgs | UpdateSubDaosArgs;
    [k: string]: unknown;
}
/**
...
export interface GetSubDaoArgs {
    address: string;
}
...
export declare class Client {
    ...
    queryGetSubDao: (args: GetSubDaoArgs) => Promise<SubDao>;
    queryDaoURI: () => Promise<Nullable_String>;
