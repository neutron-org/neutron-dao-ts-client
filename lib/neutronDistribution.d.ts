...
export declare class Client {
    ...
    queryPending: () => Promise<ArrayOfTupleOf_AddrAnd_Uint128>;
    queryShares: () => Promise<ArrayOfTupleOf_AddrAnd_Uint128>;
    ...
    setShares: (sender: string, args: SetSharesArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    fund: (sender: string, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    claim: (sender: string, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
