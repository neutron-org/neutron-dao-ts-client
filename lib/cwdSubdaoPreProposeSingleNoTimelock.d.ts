...
export interface CwdSubdaoPreProposeSingleNoTimelockSchema {
...
export declare class Client {
    ...
    queryProposalModule: () => Promise<Addr>;
    queryDao: () => Promise<Addr>;
    queryConfig: () => Promise<Config>;
    queryDepositInfo: (args: DepositInfoArgs) => Promise<DepositInfoResponse>;
    queryQueryExtension: (args: QueryExtensionArgs) => Promise<Binary>;
    ...
    proposalCreatedHook: (sender: string, args: ProposalCreatedHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    proposalCompletedHook: (sender: string, args: ProposalCompletedHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
}
