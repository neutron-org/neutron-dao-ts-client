...
export interface LockdropVaultSchema {
...
export interface Config {
    ...
    name: string;
    oracle_atom_contract: Addr;
    oracle_usdc_contract: Addr;
    owner: Addr;
    [k: string]: unknown;
}
...
export interface UpdateConfigArgs {
    ...
    lockdrop_contract?: string | null;
    name?: string | null;
    oracle_atom_contract?: string | null;
    oracle_usdc_contract?: string | null;
    owner?: string | null;
    [k: string]: unknown;
}
