...
export interface CwdProposalMultipleSchema {
    responses: Config | Addr1 | VoteResponse | InfoResponse | ProposalListResponse | VoteListResponse | ProposalResponse1 | Uint641 | ProposalCreationPolicy | HooksResponse | ProposalListResponse1 | HooksResponse1;
    query: ProposalArgs | GetVoteArgs | ListVotesArgs;
    execute: ProposeArgs | VoteArgs | ExecuteArgs | CloseArgs | UpdateConfigArgs | UpdatePreProposeInfoArgs | AddProposalHookArgs | RemoveProposalHookArgs | AddVoteHookArgs | RemoveVoteHookArgs;
    [k: string]: unknown;
}
/**
...
export interface MultipleChoiceProposal {
    /**
     * Whether DAO members are allowed to change their votes. When disabled, proposals can be executed as soon as they pass. When enabled, proposals can only be executed after the voting period has ended and the proposal passed.
     */
    allow_revoting: boolean;
    /**
...
export declare class Client {
    ...
    queryProposal: (args: ProposalArgs) => Promise<ProposalResponse>;
    queryListProposals: () => Promise<ProposalListResponse>;
    queryReverseProposals: () => Promise<ProposalListResponse>;
    queryProposalCount: () => Promise<Uint64>;
    queryGetVote: (args: GetVoteArgs) => Promise<VoteResponse>;
    queryListVotes: (args: ListVotesArgs) => Promise<VoteListResponse>;
    queryProposalCreationPolicy: () => Promise<ProposalCreationPolicy>;
    queryProposalHooks: () => Promise<HooksResponse>;
    queryVoteHooks: () => Promise<HooksResponse>;
    queryDao: () => Promise<Addr>;
    queryInfo: () => Promise<InfoResponse>;
    propose: (sender: string, args: ProposeArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    vote: (sender: string, args: VoteArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    execute: (sender: string, args: ExecuteArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    close: (sender: string, args: CloseArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateConfig: (sender: string, args: UpdateConfigArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updatePreProposeInfo: (sender: string, args: UpdatePreProposeInfoArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    addProposalHook: (sender: string, args: AddProposalHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    removeProposalHook: (sender: string, args: RemoveProposalHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    addVoteHook: (sender: string, args: AddVoteHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    removeVoteHook: (sender: string, args: RemoveVoteHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
}
