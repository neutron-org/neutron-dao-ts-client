...
export interface NeutronVotingRegistrySchema {
    responses: Config | Addr1 | InfoResponse | TotalPowerAtHeightResponse | VotingPowerAtHeightResponse | ArrayOfVotingVault;
...
export declare class Client {
    ...
    queryVotingVaults: () => Promise<ArrayOfVotingVault>;
    ...
    addVotingVault: (sender: string, args: AddVotingVaultArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    deactivateVotingVault: (sender: string, args: DeactivateVotingVaultArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    activateVotingVault: (sender: string, args: ActivateVotingVaultArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
