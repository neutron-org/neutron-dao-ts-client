...
export interface CwdSubdaoCoreSchema {
    responses: ArrayOfProposalModule | Config | String | DumpStateResponse | GetItemResponse | InfoResponse | ArrayOfTupleOf_StringAnd_String | ArrayOfSubDao | Addr1 | PauseInfoResponse1 | ArrayOfProposalModule1 | TotalPowerAtHeightResponse | Boolean | Addr2 | VotingPowerAtHeightResponse;
    query: GetItemArgs | VerifyTimelockArgs | VotingPowerAtHeightArgs;
    execute: ExecuteProposalHookArgs | ExecuteTimelockedMsgsArgs | RemoveItemArgs | SetItemArgs | UpdateConfigArgs | UpdateProposalModulesArgs | UpdateVotingModuleArgs | UpdateSubDaosArgs | PauseArgs;
    [k: string]: unknown;
}
/**
...
export declare class Client {
    ...
    queryDumpState: () => Promise<DumpStateResponse>;
    queryGetItem: (args: GetItemArgs) => Promise<GetItemResponse>;
    queryListItems: () => Promise<ArrayOfTupleOf_StringAnd_String>;
    queryProposalModules: () => Promise<ArrayOfProposalModule>;
    queryActiveProposalModules: () => Promise<ArrayOfProposalModule>;
    queryVotingModule: () => Promise<Addr>;
    queryListSubDaos: () => Promise<ArrayOfSubDao>;
    queryDaoURI: () => Promise<String>;
    queryMainDao: () => Promise<Addr>;
    queryVerifyTimelock: (args: VerifyTimelockArgs) => Promise<Boolean>;
    ...
    executeProposalHook: (sender: string, args: ExecuteProposalHookArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    executeTimelockedMsgs: (sender: string, args: ExecuteTimelockedMsgsArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    removeItem: (sender: string, args: RemoveItemArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    setItem: (sender: string, args: SetItemArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateConfig: (sender: string, args: UpdateConfigArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateProposalModules: (sender: string, args: UpdateProposalModulesArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateVotingModule: (sender: string, args: UpdateVotingModuleArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateSubDaos: (sender: string, args: UpdateSubDaosArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
